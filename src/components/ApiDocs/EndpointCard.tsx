    ...
    <Card className="mb-6 sm:mb-8 border-border">
      <CardHeader className="pb-4">
        <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-3">
          ...
          <code className="text-sm sm:text-lg font-mono bg-secondary px-3 py-2 rounded-lg border border-border break-all">
            {endpoint}
          </code>
        </div>
            ...
            <div>
              ...
              <Tabs defaultValue="query" className="w-full">
                <TabsList className="grid w-full grid-cols-2">
                  <TabsTrigger value="query" className="text-xs sm:text-sm">Query Parameter</TabsTrigger>
